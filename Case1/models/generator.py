...
class Generator(Module):
    def __init__(self, args):
        ...
        self.nn_0 = NNBlock(16 * self.nf, 16 * self.nf)
        self.nn_1 = NNBlock(16 * self.nf, 16 * self.nf)
        self.nn_2 = NNBlock(16 * self.nf, 8 * self.nf)
        self.nn_3 = NNBlock(8 * self.nf, 4 * self.nf)
        self.nn_4 = NNBlock(4 * self.nf, 2 * self.nf)
        self.nn_5 = NNBlock(2 * self.nf, self.nf)
        self.conv_img = nn.Conv2d(self.nf, args.img_nc, 3, padding=1)
